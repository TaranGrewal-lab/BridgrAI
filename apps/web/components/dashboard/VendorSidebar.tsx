...
const NAV = [
  ...
  { label: "Profile", href: "/vendor-dashboard/profile" },
  { label: "Photos", href: "/vendor-dashboard/photos" },
  { label: "Analytics", href: "/vendor-dashboard/analytics" },
  { label: "Subscription", href: "/vendor-dashboard/subscription" },
];

export function VendorSidebar({ active }: { active?: string }) {
  return (
    <aside className="hidden w-56 flex-col border-r border-sage/30 bg-white px-4 py-6 md:flex">
      <div className="mb-8 flex items-center gap-2 px-2">
        ...
        <div className="leading-tight">
          ...
          <p className="text-[9px] uppercase tracking-[0.2em] text-gold">Vendor Partner</p>
        </div>
      </div>
